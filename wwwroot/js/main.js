...
var author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A3(author$project$Main$Model, key, url, author$project$Main$Dashboard),
...
var author$project$Main$OnPlayerDetailResults = function (a) {
	return {$: 'OnPlayerDetailResults', a: a};
};
var author$project$Main$OnSearchResults = function (a) {
	return {$: 'OnSearchResults', a: a};
};
var author$project$Main$PlayerDetails = F2(
	function (a, b) {
		return {$: 'PlayerDetails', a: a, b: b};
	});
var author$project$Main$PlayerSearch = function (a) {
	return {$: 'PlayerSearch', a: a};
};
var author$project$Main$PlayerSearchResults = function (a) {
	return {$: 'PlayerSearchResults', a: a};
};
var author$project$Main$GameSearch = function (a) {
	return {$: 'GameSearch', a: a};
};
				...
				[
					...
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$PlayerSearch('')
							}),
						elm$core$Platform$Cmd$none)),
					A2(
					author$project$Main$route,
					...
					function (name) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: A2(author$project$Main$PlayerDetails, name, _List_Nil)
								}),
							elm$core$Platform$Cmd$none);
					}),
					A2(
					...
					function (id) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: author$project$Main$GameSearch(id)
								}),
							elm$core$Platform$Cmd$none);
					}),
					A2(
...
var author$project$Main$playerDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Main$Player,
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'playerId', elm$json$Json$Decode$string));
var author$project$Main$PlayerDetail = F7(
	function (name, playerId, bbrefId, yearId, hits, homeRuns, runsBattedIn) {
		return {bbrefId: bbrefId, hits: hits, homeRuns: homeRuns, name: name, playerId: playerId, runsBattedIn: runsBattedIn, yearId: yearId};
	});
var elm$json$Json$Decode$int = _Json_decodeInt;
var elm$json$Json$Decode$map7 = _Json_map7;
var author$project$Main$playerDetailDecoder = A8(
	elm$json$Json$Decode$map7,
	author$project$Main$PlayerDetail,
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'playerId', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'bbrefId', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'yearId', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'hits', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'homeRuns', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'runsBattedIn', elm$json$Json$Decode$int));
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UrlChanged':
				var url = msg.a;
				return A2(author$project$Main$parseUrl, url, model);
			case 'SearchChange':
				var q = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: author$project$Main$PlayerSearch(q)
						}),
					elm$core$Platform$Cmd$none);
			case 'RunSearch':
				var q = msg.a;
				return _Utils_Tuple2(
					...
					A2(
						elm$http$Http$send,
						author$project$Main$OnSearchResults,
						A2(
							elm$http$Http$get,
							'/api/search/' + q,
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$PlayerSearchResults(players)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			...
			case 'GetPlayerDetails':
				...
				return _Utils_Tuple2(
					...
					A2(
						elm$http$Http$send,
						author$project$Main$OnPlayerDetailResults,
						A2(
							elm$http$Http$get,
							'/api/player/' + id,
							elm$json$Json$Decode$list(author$project$Main$playerDetailDecoder))));
			default:
				var result = msg.a;
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: A2(author$project$Main$PlayerDetails, 'fake', details)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
...
var author$project$Main$viewDash = A2(
	elm$html$Html$ul,
	_List_Nil,
	_List_fromArray(
		[
			A2(author$project$Main$viewLink, '/help', 'Get Help'),
			A2(author$project$Main$viewLink, '/dashboard', 'Go Home'),
			A2(author$project$Main$viewLink, '/player/dave', 'Get Info on Dave'),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						elm$core$String$fromInt(detail.yearId))
					])),
				A2(
				elm$html$Html$td,
				_List_Nil,
				...
				_List_fromArray(
					[
						elm$html$Html$text(detail.playerId)
					])),
				A2(
				elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(
						elm$core$String$fromInt(detail.hits))
					])),
				A2(
				elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(
						elm$core$String$fromInt(detail.homeRuns))
					])),
				A2(
				elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(
						elm$core$String$fromInt(detail.runsBattedIn))
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Runs Batted In')
							]))
					])),
				A2(
				elm$html$Html$tbody,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text('Player Details for ' + id)
						])),
					author$project$Main$viewDetails(details)
				]));
	});
var author$project$Main$GetPlayerDetails = function (a) {
	return {$: 'GetPlayerDetails', a: a};
};
var author$project$Main$viewLinkForPlayer = function (player) {
	return A2(
		elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$href('/player/' + player.playerId),
						elm$html$Html$Events$onClick(
						author$project$Main$GetPlayerDetails(player.playerId))
					]),
				_List_fromArray(
					[
...
var author$project$Main$viewPlayers = function (players) {
	return A2(
		elm$html$Html$ul,
		_List_Nil,
		A2(elm$core$List$map, author$project$Main$viewLinkForPlayer, players));
};
var author$project$Main$viewResults = function (players) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				author$project$Main$viewPlayers(players)
			]));
};
var author$project$Main$RunSearch = function (a) {
	return {$: 'RunSearch', a: a};
};
var author$project$Main$SearchChange = function (a) {
	return {$: 'SearchChange', a: a};
};
...
var author$project$Main$viewSearch = function (searchString) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$placeholder('Partial player name'),
						elm$html$Html$Attributes$value(searchString),
						elm$html$Html$Events$onInput(author$project$Main$SearchChange)
					]),
				_List_Nil),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(
						author$project$Main$RunSearch(searchString))
					]),
				_List_fromArray(
					[
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Player":{"args":[],"type":"{ name : String.String, playerId : String.String }"},"Main.PlayerDetail":{"args":[],"type":"{ name : String.String, playerId : String.String, bbrefId : String.String, yearId : Basics.Int, hits : Basics.Int, homeRuns : Basics.Int, runsBattedIn : Basics.Int }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Http.Response":{"args":["body"],"type":"{ url : String.String, status : { code : Basics.Int, message : String.String }, headers : Dict.Dict String.String String.String, body : body }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"RunSearch":["String.String"],"SearchChange":["String.String"],"OnSearchResults":["Result.Result Http.Error (List.List Main.Player)"],"GetPlayerDetails":["String.String"],"OnPlayerDetailResults":["Result.Result Http.Error (List.List Main.PlayerDetail)"],"NoOp":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Response String.String"],"BadPayload":["String.String","Http.Response String.String"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));